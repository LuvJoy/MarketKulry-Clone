...
class ProductRecyclerViewHolder(private var itemView: View, private var context: Context) :
    ...
    private var tvSalePrice: TextView =
        itemView.findViewById<TextView>(R.id.item_sale_price_textview)
    private var tvSalePriceDummy: TextView =
        itemView.findViewById<TextView>(R.id.item_sale_price_dummytext)
    ...
    private var layoutSalePercent: ConstraintLayout =
        itemView.findViewById<ConstraintLayout>(R.id.item_sale_percentage_layout)
    private var tvSalePercent: TextView =
        layoutSalePercent.findViewById(R.id.salesign_percent_textview)
