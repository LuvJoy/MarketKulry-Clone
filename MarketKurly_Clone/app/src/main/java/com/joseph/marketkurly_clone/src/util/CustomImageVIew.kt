...
class FitYCropXImageView : androidx.appcompat.widget.AppCompatImageView {
    ...
    protected override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        drawableRect[0f, 0f, drawableWidth.toFloat()] = drawableHeight.toFloat() //Represents the original image
        ...
        viewRect[viewHalfWidth - scaledHalfWidth, 0f, viewHalfWidth + scaledHalfWidth] = viewHeight.toFloat()
